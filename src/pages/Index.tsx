...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>BusinessHub - Discover Trusted Desi Businesses & Services in the USA</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://BusinessHub.com" />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            potentialAction: {
              "@type": "SearchAction",
              target: "https://BusinessHub.com/search?q={search_term_string}",
